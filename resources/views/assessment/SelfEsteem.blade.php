...
<head>
    ...
    <meta name="description" content="Self-Esteem Assessment — A peaceful, confidential clinical screening tool to help you measure and understand your self-worth, confidence, and self-image.">
    <title>Self-Esteem Assessment  – Therawell</title>
...
<div class="gad-page-wrapper">
    ...
    <div class="gad-content-container">
        ...
        <div class="gad-header-section" id="gadHeaderSection">
            ...
            <!-- Heading -->
            <h1 class="gad-heading">Self-Esteem Assessment</h1>
            ...
            <!-- Subtitle -->
            <p class="gad-subtitle">Take a gentle, quiet moment to reflect on your confidence, self-worth, and inner strength.</p>
        </div>
                ...
                <div class="gad-card-pane active" id="pane-disclaimer">
                    ...
                    <div class="gad-info-row">
                        ...
                        <div class="gad-info-text">
                            <div class="gad-info-title">Self-Esteem Screening</div>
                            <div class="gad-info-desc">This screening is designed to help you reflect on your feelings of self-worth, confidence, self-acceptance, and personal value over the last two weeks.</div>
                        </div>
                    </div>
                    ...
                    <div class="gad-info-row">
                        ...
                        <div class="gad-info-text">
                            ...
                            <div class="gad-info-desc">If severe self-doubt, distress, or persistent negative self-talk are impacting your mental well-being and daily life, please reach out to local supportive professionals.</div>
                        </div>
                    </div>
                    ...
                    <div class="gad-complete-content">
                        ...
                        <div class="gad-complete-summary">
                            ...
                            <div class="gad-summary-item">
                                ...
                                <strong>Self-Esteem Screening</strong>
                            </div>
                            <p class="gad-complete-note">
                                Your answers will be analyzed to assess your recent self-esteem and self-worth index. Remember, you are valued and deserving of respect.
                            </p>
                        </div>

                        <!-- Form submission -->
                        <form id="gadSubmitForm" action="/assessment/self/submit" method="POST" style="width:100%;">
                            @csrf
...
// Self-Esteem questions mapping
var SELF_ESTEEM_QUESTIONS = [
    @foreach($questions as $q)
    { id: {{ $q->id }}, text: @json($q->question_text) },
    @endforeach
];

var SELF_ESTEEM_OPTIONS = [
    { value: 0, label: 'Never' },
...
function renderQuestionInSlide(slideId, idx) {
    ...
    var q = SELF_ESTEEM_QUESTIONS[idx];
    var total = SELF_ESTEEM_QUESTIONS.length;
    ...
    SELF_ESTEEM_OPTIONS.forEach(function(opt) {
...
function selectAnswerFlow(qId, val){
    ...
    setTimeout(function(){
        ...
        if(currentIdx < SELF_ESTEEM_QUESTIONS.length - 1){
            currentIdx++;
