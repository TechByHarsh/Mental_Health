...
<div class="gad-page-wrapper">
    ...
    <div class="gad-content-container">
        ...
        <div class="gad-header-section" id="gadHeaderSection">
            ...
            <!-- Heading -->
            <h1 class="gad-heading">Social Anxiety Assessment</h1>
            ...
            <!-- Subtitle -->
            <p class="gad-subtitle">A calm, gentle space to reflect on and understand your social comfort levels.</p>
        </div>
                ...
                <div class="gad-card-pane active" id="pane-disclaimer">
                    ...
                    <div class="gad-info-row">
                        ...
                        <div class="gad-info-text">
                            <div class="gad-info-title">Social Comfort Screening</div>
                            <div class="gad-info-desc">This screening is designed to measure levels of self-consciousness, performance anxiety, and social comfort over the last two weeks. It is gentle, private, and non-diagnostic.</div>
                        </div>
                    </div>
                    ...
                    <div class="gad-info-row">
                        ...
                        <div class="gad-info-text">
                            ...
                            <div class="gad-info-desc">All response metrics are fully encrypted and securely stored. We respect your confidentiality and never share assessment metrics with anyone else.</div>
                        </div>
                    </div>
                    ...
                    <div class="gad-info-row">
                        ...
                        <div class="gad-info-text">
                            <div class="gad-info-title">Supportive Environment</div>
                            <div class="gad-info-desc">This space is dedicated to calm exploration. If you ever feel severe anxiety or panic, take a deep breath; you are in a safe, peaceful digital sanctuary.</div>
                        </div>
                    </div>
                    ...
                    <div class="gad-complete-content">
                        ...
                        <div class="gad-complete-summary">
                            ...
                            <div class="gad-summary-item">
                                ...
                                <strong>Social Anxiety Screening</strong>
                            </div>
                            <p class="gad-complete-note">
                                Your screening results will be processed carefully. Reflecting on social patterns is a highly courageous step toward thriving in public spheres.
                            </p>
                        </div>

                        <!-- Form submission -->
                        <form id="gadSubmitForm" action="/assessment/socialanxiety/submit" method="POST" style="width:100%;">
                            @csrf
...
function renderQuestionInSlide(slideId, idx) {
    ...
    SOCIAL_OPTIONS.forEach(function(opt) {
...
function selectAnswerFlow(qId, val){
    ...
    setTimeout(function(){
        ...
        if(currentIdx < SOCIAL_QUESTIONS.length - 1){
            currentIdx++;
