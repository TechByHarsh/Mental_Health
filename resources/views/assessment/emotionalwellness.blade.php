...
<head>
    ...
    <meta name="description" content="Emotional Wellness Assessment — A peaceful, gentle space to help you understand, reflect on, and support your emotional health.">
    <title>Emotional Wellness Assessment – TherawellTherawell</title>
...
<div class="gad-page-wrapper">
    ...
    <div class="gad-content-container">
        ...
        <div class="gad-header-section" id="gadHeaderSection">
            ...
            <!-- Heading -->
            <h1 class="gad-heading">Emotional Wellness Assessment</h1>
            ...
            <!-- Subtitle -->
            <p class="gad-subtitle">A gentle, reflective screening designed to help you understand, measure, and support your emotional balance.</p>
        </div>
                ...
                <div class="gad-card-pane active" id="pane-disclaimer">
                    ...
                    <div class="gad-info-row">
                        ...
                        <div class="gad-info-text">
                            <div class="gad-info-title">Emotional Well-Being Screening</div>
                            <div class="gad-info-desc">This screening helps you reflect on your emotional balance, self-compassion, connection, and stress management over the past two weeks. It is completely supportive and confidential.</div>
                        </div>
                    </div>
                    ...
                    <div class="gad-info-row">
                        ...
                        <div class="gad-info-text">
                            ...
                            <div class="gad-info-desc">If overwhelming distress, anxiety, or intense mood swings are affecting your physical and mental safety, please reach out to your local professional support resources.</div>
                        </div>
                    </div>
                    ...
                    <div class="gad-complete-content">
                        ...
                        <div class="gad-complete-summary">
                            ...
                            <div class="gad-summary-item">
                                ...
                                <strong>Emotional Wellness Screening</strong>
                            </div>
                            <p class="gad-complete-note">
                                Your answers will be analyzed to assess your emotional wellness scale. May you continue to grow in self-compassion, resilience, and inner peace.
                            </p>
                        </div>

                        <!-- Form submission -->
                        <form id="gadSubmitForm" action="/assessment/emotionalwellness/submit" method="POST" style="width:100%;">
                            @csrf
...
// Emotional Wellness questions mapping
var EMOTIONAL_WELLNESS_QUESTIONS = [
    @foreach($questions as $q)
    { id: {{ $q->id }}, text: @json($q->question_text) },
    @endforeach
];

var EMOTIONAL_WELLNESS_OPTIONS = [
    { value: 0, label: 'Never' },
...
function renderQuestionInSlide(slideId, idx) {
    ...
    var q = EMOTIONAL_WELLNESS_QUESTIONS[idx];
    var total = EMOTIONAL_WELLNESS_QUESTIONS.length;
    ...
    EMOTIONAL_WELLNESS_OPTIONS.forEach(function(opt) {
...
function selectAnswerFlow(qId, val){
    ...
    setTimeout(function(){
        ...
        if(currentIdx < EMOTIONAL_WELLNESS_QUESTIONS.length - 1){
            currentIdx++;
