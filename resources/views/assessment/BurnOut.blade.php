...
<div class="gad-page-wrapper">
    ...
    <div class="gad-content-container">
        ...
        <div class="gad-header-section" id="gadHeaderSection">
            ...
            <!-- Heading -->
            <h1 class="gad-heading">Burnout Assessment</h1>
            ...
            <!-- Subtitle -->
            <p class="gad-subtitle">A supportive, confidential clinical screening tool to help you measure and support your energy, focus, and work-life balance.</p>
        </div>
                ...
                <div class="gad-card-pane active" id="pane-disclaimer">
                    ...
                    <div class="gad-info-row">
                        ...
                        <div class="gad-info-text">
                            <div class="gad-info-title">Burnout & Energy Screening</div>
                            <div class="gad-info-desc">This screening helps track indicators of occupational exhaustion, chronic stress, mental fatigue, and alignment with your daily activities. It is completely supportive and confidential.</div>
                        </div>
                    </div>
                    ...
                    <div class="gad-info-row">
                        ...
                        <div class="gad-info-text">
                            ...
                            <div class="gad-info-desc">If chronic burnout, extreme stress, or severe emotional fatigue are affecting your physical, mental, or occupational safety, please reach out to your local clinical healthcare team.</div>
                        </div>
                    </div>
                    ...
                    <div class="gad-complete-content">
                        ...
                        <div class="gad-complete-summary">
                            ...
                            <div class="gad-summary-item">
                                ...
                                <strong>Burnout Screening</strong>
                            </div>
                            <p class="gad-complete-note">
                                Your answers will be analyzed to assess your recent energy and work stress index. May you find professional balance, deep renewal, and peaceful boundaries ahead.
                            </p>
                        </div>

                        <!-- Form submission -->
                        <form id="gadSubmitForm" action="/assessment/BurnOut/submit" method="POST" style="width:100%;">
                            @csrf
...
// Burnout questions mapping
var BURNOUT_QUESTIONS = [
...
function renderQuestionInSlide(slideId, idx) {
    ...
    var q = BURNOUT_QUESTIONS[idx];
    var total = BURNOUT_QUESTIONS.length;
    ...
    BURNOUT_OPTIONS.forEach(function(opt) {
...
function selectAnswerFlow(qId, val){
    ...
    setTimeout(function(){
        ...
        if(currentIdx < BURNOUT_QUESTIONS.length - 1){
            currentIdx++;
