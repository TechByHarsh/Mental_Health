...
<head>
    ...
    <meta name="description" content="Relationship Health Assessment — A peaceful, confidential clinical screening tool to help you evaluate and understand your relationship patterns, connection, and emotional support.">
    <title>Relationship Health Assessment  – Therawell</title>
...
<div class="gad-page-wrapper">
    ...
    <div class="gad-content-container">
        ...
        <div class="gad-header-section" id="gadHeaderSection">
            ...
            <!-- Heading -->
            <h1 class="gad-heading">Relationship Health Assessment</h1>
            ...
            <!-- Subtitle -->
            <p class="gad-subtitle">Take a gentle, quiet moment to reflect on your connection, boundaries, and communication with loved ones.</p>
        </div>
                ...
                <div class="gad-card-pane active" id="pane-disclaimer">
                    ...
                    <div class="gad-info-row">
                        ...
                        <div class="gad-info-text">
                            <div class="gad-info-title">Relationship Health Screening</div>
                            <div class="gad-info-desc">This screening is designed to help you reflect on your connection, trust, open communication, emotional support, and conflict resolution over the past two weeks.</div>
                        </div>
                    </div>
                    ...
                    <div class="gad-info-row">
                        ...
                        <div class="gad-info-text">
                            ...
                            <div class="gad-info-desc">If severe conflict, safety concerns, or distressing relationship challenges are heavily impacting your physical and emotional security, please reach out to professional counseling services or local lifelines.</div>
                        </div>
                    </div>
                    ...
                    <div class="gad-complete-content">
                        ...
                        <div class="gad-complete-summary">
                            ...
                            <div class="gad-summary-item">
                                ...
                                <strong>Relationship Health Screening</strong>
                            </div>
                            <p class="gad-complete-note">
                                Your answers will be analyzed to assess your recent relationship health and connection index. May your connections bring support, comfort, and peace.
                            </p>
                        </div>

                        <!-- Form submission -->
                        <form id="gadSubmitForm" action="/assessment/relationshiphealth/submit" method="POST" style="width:100%;">
                            @csrf
...
// Relationship Health questions mapping
var RELATIONSHIP_HEALTH_QUESTIONS = [
    @foreach($questions as $q)
    { id: {{ $q->id }}, text: @json($q->question_text) },
    @endforeach
];

var RELATIONSHIP_HEALTH_OPTIONS = [
    { value: 0, label: 'Never' },
...
function renderQuestionInSlide(slideId, idx) {
    ...
    var q = RELATIONSHIP_HEALTH_QUESTIONS[idx];
    var total = RELATIONSHIP_HEALTH_QUESTIONS.length;
    ...
    RELATIONSHIP_HEALTH_OPTIONS.forEach(function(opt) {
...
function selectAnswerFlow(qId, val){
    ...
    setTimeout(function(){
        ...
        if(currentIdx < RELATIONSHIP_HEALTH_QUESTIONS.length - 1){
            currentIdx++;
